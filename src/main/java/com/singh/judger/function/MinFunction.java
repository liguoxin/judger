 ...
 * @desc
 */
public class MinFunction implements Function<List<Number>, Number> {
    ...
    public Number apply(List<Number> numberList) {
        ...
        Optional<Number> optionalNumber = numberList.stream().min(Comparator.comparing(Number::doubleValue));
